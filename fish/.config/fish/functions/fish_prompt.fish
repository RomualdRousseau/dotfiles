function fish_prompt
    # Define colors inline with 'wal'
    set -l N1 (set_color -b $fish_color_color5)(set_color $fish_color_color7)
    set -l N2 (set_color -b $fish_color_color4)(set_color $fish_color_color5)
    set -l N3 (set_color -b $fish_color_color4)(set_color $fish_color_color7)
    set -l N4 (set_color -b normal)(set_color $fish_color_color4)
    set -l N5 (set_color -b $fish_color_color7)(set_color $fish_color_color5)
    set -l N6 (set_color -b $fish_color_color5)(set_color $fish_color_color7)    
    set -l N7 (set_color -b normal)(set_color $fish_color_color7)    

    # User and hostname segment
    set -l host (echo $hostname | sed 's/\..*$//')
    echo -nes $N7 \uE0B6 $N5 $USER "@" $host " " $N6 \uE0B4
